    ...
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
                <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 dark:text-white">{t('cta.title')}</h2>
                <p className="text-xl text-slate-600 dark:text-slate-400 mb-10">{t('cta.subtitle')}</p>
